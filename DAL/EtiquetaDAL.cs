        ...
        public static List<Entidades.Etiqueta> Obtener(Entidades.Filtro filtro)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    //BeginFields
                    var numex = (int)(!reader.IsDBNull(NUMERO) ? reader.GetValue(NUMERO) : 0);
                    OBJ.Id = (int)(!reader.IsDBNull(ID) ? reader.GetValue(ID) : 0);
                    OBJ.Año = (int)(!reader.IsDBNull(AÑO) ? reader.GetValue(AÑO) : 0);
                    ...
                    OBJ.Numero = numex.ToString() + "/" + OBJ.Año;
                    //EndFields
